...
<!-- SPINE -->
<div id="spine" class="spine-column shelved bleed">
...
echo Menu::widget([
    'items' => [
		...
		['label' => 'Create Account', 'url' => ['user/login'], 'visible' => Yii::$app->user->isGuest],
		['label' => 'Log Out', 'options'=>['id'=>'logout'],'url' => ['user/logout'], 'visible' => !Yii::$app->user->isGuest]
    ],
]);	
	...
	?>
		...
		<!--<ul>-->
			...
			<li><a href="spine.min.html">Minimal Markup</a></li>
		</ul>-->
